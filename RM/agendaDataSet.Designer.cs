...
namespace RM {
    ...
    public partial class agendaDataSet : global::System.Data.DataSet {
        ...
        public partial class matriculaDataTable : global::System.Data.TypedTableBase<matriculaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public matriculaRow AddmatriculaRow(int rm, string nome, string rg) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public matriculaRow FindByrm(int rm) {
        ...
        public partial class matriculaRow : global::System.Data.DataRow {
            ...
            public int rm {
                get {
                    return ((int)(this[this.tablematricula.rmColumn]));
                }
                set {
                    this[this.tablematricula.rmColumn] = value;
                }
            }
            ...
            public string nome {
                get {
                    return ((string)(this[this.tablematricula.nomeColumn]));
                }
                set {
                    this[this.tablematricula.nomeColumn] = value;
                }
            }
            ...
            public string rg {
                get {
                    return ((string)(this[this.tablematricula.rgColumn]));
                }
                set {
                    this[this.tablematricula.rgColumn] = value;
                }
            }
        }
...
namespace RM.agendaDataSetTableAdapters {
    ...
    public partial class matriculaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `matricula` WHERE ((`rm` = @p1) AND (`nome` = @p2) AND (`rg` = @p3))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `matricula` (`rm`, `nome`, `rg`) VALUES (@p1, @p2, @p3)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `matricula` SET `rm` = @p1, `nome` = @p2, `rg` = @p3 WHERE ((`rm` = @p4) A" +
                "ND (`nome` = @p5) AND (`rg` = @p6))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RM.Properties.Settings.Default.agendaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `rm`, `nome`, `rg` FROM `matricula`";
        ...
        public virtual int Fill(agendaDataSet.matriculaDataTable dataTable) {
        ...
        public virtual agendaDataSet.matriculaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            agendaDataSet.matriculaDataTable dataTable = new agendaDataSet.matriculaDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(agendaDataSet.matriculaDataTable dataTable) {
